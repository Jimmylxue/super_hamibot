declare module 'sensors' {
	...
	interface Sensors {
		...
		register(
			...
			delay?: number
		): AccelerometerEventEmitter | null
		...
		register(
			...
			delay?: number
		): MagneticFieldEventEmitter | null
		...
		register(
			...
			delay?: number
		): LinearAccelerationEventEmitter | null
		...
		register(
			...
			delay?: number
		): AmbientTemperatureEventEmitter | null
		...
		register(
			...
			delay?: number
		): RelativeHumidityEventEmitter | null
		...
		on(
			...
			listener: (sensorName: string) => any
		): this
	...
	type LinearAccelerationEventEmitter =
		AddChangeEventListener<LinearAccelerationListener>

	type AmbientTemperatureEventEmitter =
		AddChangeEventListener<AmbientTemperatureListener>
	...
	type RelativeHumidityEventEmitter =
		AddChangeEventListener<RelativeHumidityListener>
