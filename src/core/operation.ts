 ...
 * 随机滑动
 */
export function randomSwipe(sx: number, sy: number, ex: number, ey: number) {
	//设置控制点极限距离
	var leaveMax = 150
	//设置随机滑动时长范围
	var timeMin = 300
	...
	let cx1 = centerX + random(0, leaveMax)
	let cy1 = centerY + random(0, leaveMax)
	let cx2 = centerX - random(0, leaveMax)
	let cy2 = centerY - random(0, leaveMax)
